        ...
        <Listbox value={selected} onChange={setSelected}>
          <div className="relative mt-2">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute hide-scrollbar mt-1 max-h-60 w-full overflow-auto rounded-lg bg-white dark:bg-slate-700 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                <Listbox.Option
                  name="tipo"
                  className={({ active }) =>
