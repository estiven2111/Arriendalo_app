      ...
      <div className="flex items-center justify-between px-10 gap-3 py-2">
        {property.user.map((el, i) => (
          <a
            ...
            href={el.whatsapp}
            target="_blanck"
            className=" flex text-xs text-white items-center justify-center  cursor-pointer gap-3 duration-300 hover:saturate-200 rounded-full px-6  bg-gradient-to-r from-indigo-400 to-indigo-600 p-2"
          >
            <MdCalendarMonth />
            Agendar Visita
          </a>
        ...
        <Link to="/aplicar_tomador">
          <div className=" flex items-center text-xs justify-center gap-2 rounded-full cursor-pointer duration-500 hover:border-indigo-500 px-6 border-2 border-gradient-to-r from-indigo-400 to-indigo-600 py-2">
