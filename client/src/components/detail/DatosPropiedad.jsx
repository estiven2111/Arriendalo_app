...
const DatosPropiedad = () => {
  ...
  console.log("ssssssssssss", property);
  ...
  return (
    <div className="md:px-32 md:py-28 pt-28 pb-10 px-5 ">
      {isLoading ? (
        <div>{<Loading />}</div>
      ) : (
        <div>
          <div>
                ...
                <div className="flex">
                  ...
                  <div className=" flex items-center">
                    {property.admin && ( //! admin
                      <p className="bg-neutral-300/80 dark:text-black  px-2 text-xs rounded-full  ">
                        Admin incluida
                      </p>
                    )}
                  </div>
            ...
            <PropertyGallery images={property.imagenes} />
            ...
            <div className="grid lg:grid-cols-5 sm:grid-cols-1 gap-10 py-5">
              <div className="col-span-3">
                ...
                <div className="lg:flex flex-wrap sm:grid md:grid-cols-3 gap-5 dark:text-black items-center justify-start mt-5">
                  ...
                  {property.exclusivo && ( //!petfriendly
                    <div
                          ...
                          <div className="flex items-center justify-center p-5">
                            <div className="h-20 rounded-full w-24 ">
                              <img
                                ...
                                src={el.photo}
                                alt="agente encargado de la propiedad"
                              />
                            </div>
                          </div>
                          <div className="">
