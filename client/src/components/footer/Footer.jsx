    ...
    <div className="py-2 lg:pb-0 md:pb-20 mt-10">
      <div className="flex-row items-center justify-center dark:from-transparent dark:to-slate-900 bg-gradient-to-b from-transparent to-slate-100">
          ...
          <div className="order-first">
            <Link to="/">
              <div className="flex justify-center">
                {theme === "dark" ? (
                  <img className="w-36" src={logowhite} alt="White Logo" />
                ) : (
                  <img className="w-36" src={logoblue} alt="Blue Logo" />
                )}
              </div>
            </Link>
          </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
          <div className="flex-row gap-5 justify-evenly w-full px-20 ">
            <li className="text-sm ">
              Oficina Bogotá: Carrera 7 N° 156 - 68 | Oficina 1804 | North Point
              III
            </li>
            <li className="text-sm ">
