...
const PropiedadCard = ({ propiedad }) => {
  ...
  return (
    <div
      className={`md:w-[342px] md:h-[500px] ${cardConditionalClass} hover:translate-y-[-3px] relative duration-200 to-90 `}
    >
      {/* {propiedad.exclusivo && (
      ...
      <div className="relative">
        ...
        <Slide slide={[...propiedad.imagenes]} />
      </div>
            ...
            <div className=" overflow-hidden relative  rounded-3xl ">
              {propiedad.exclusivo ? (
                <a
                  href={el.whatsapp}
                  target="_blanck"
                  className="button flex items-center justify-center gap-2 exclusive_btn"
                >
                  <MdCalendarMonth />
                  Agendar Visita
                </a>
                ...
                <a
                  href={el.whatsapp}
                  target="_blanck"
                  className="button  flex items-center justify-center gap-2 normal_btn"
                >
                  <MdCalendarMonth />
                  Agendar Visita
                </a>
