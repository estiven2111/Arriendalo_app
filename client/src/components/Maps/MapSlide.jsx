...
const MapSlide = ({ slide, propiedad }) => {
  ...
  console.log("ddddddddddddddd", slide);

  const prev = () => {
    console.log("entreeeeeeeeeeeeeeeeeeeeeeeeeeee");
        ...
        <div className="flex justify-between items-center mb-[1px] font-bold text-primaryblue ">
          ...
          <span className="text-black text-xs font-medium ">
            {propiedad.admin && ( //! admin */}
              <p className="bg-neutral-300/80 dark:text-black px-2 text-[10px] rounded-full  ">
                Admin incl
              </p>
            )}
          </span>
