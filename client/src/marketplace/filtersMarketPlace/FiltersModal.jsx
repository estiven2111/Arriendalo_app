...
const FiltersModal = ({
  ...
  console.log("modallllllllll", tipesPropertyFiltered);
  ...
  const handlerRangePrice = (value) => {
    console.log("ssssssssssssssssssssssssssss", value);
    setSearchs({
      ...searchs,
      pricemin: value[0],
      pricemax: value[1],
  ...
  return (
    ...
    >
      {console.log("golballllllllllll", filterLanding)}
      {console.log("searchsssssssss", searchs)}
